...
This package contains the Q-Press documentation site for QMediaPlayer. It owns the public documentation source, live demos, example-viewer content, generated API pages, and static-search output for audio/video player components, language notes, and demos.
