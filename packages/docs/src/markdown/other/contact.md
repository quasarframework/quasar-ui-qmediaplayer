...
Answers to the most common questions regarding QMediaPlayer can be found in the [QMediaPlayer FAQ](/developing/faq).
...
If you have a specific fix or contribution, you can generate a pull request on the [QMediaPlayer repo](https://github.com/quasarframework/quasar-ui-qmediaplayer/tree/v3-beta). Make sure to use the `next` branch for QMediaPlayer v2.x+
