<template>
  <div>
    <section class="page-header">
      ...
      <a href="https://github.com/hawkeye64/app-extension-qmediaplayer" target="_blank" class="btn">View on GitHub</a>
      <a href="https://hawkeye64.github.io/app-extension-qmediaplayer/#/demo" target="_blank" class="btn">Demo</a>
    </section>
...
.page-header {
  ...
  background-image: linear-gradient(120deg, #77eaee, #155599); }
